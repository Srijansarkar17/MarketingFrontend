...
import { Target, Lightbulb, Rocket, RefreshCw, AlertCircle, CheckCircle, type LucideIcon } from 'lucide-react';
...
const CampaignGoalStep = ({ selectedGoal, setSelectedGoal }: CampaignGoalStepProps) => {
